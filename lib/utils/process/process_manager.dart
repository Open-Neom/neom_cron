/// Process management utilities for Open Neom agents.
///
...
class Shell {
  ...
  static String detectShell() {
    ...
    if (shell != null && shell.isNotEmpty) return shell.split('/').last;
    final comspec = Platform.environment['COMSPEC'];
    if (comspec != null) return comspec.split(Platform.pathSeparator).last;
